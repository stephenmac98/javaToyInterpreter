...
public class Tester extends TestCase{
	...
	public void testTypesMatch(){
		...
		for(int k = 0; k< objectLists.length; k++){
			for(int j = 0; j<classLists.length; j++){
				System.out.println("RUNNING obj: " + k + " Class: " + j);
				if(k==j){
	...
	public void testCallMethod(){
		System.out.println("TEST CALL METHOD \n");
...
//		int a = 1;
//		int b = 2;
//		Object answer5 = ReflectionUtilities.callMethod(test, "substring", new Object[]{a, b});
//		assertTrue(answer5 == "t");
